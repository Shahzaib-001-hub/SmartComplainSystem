        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Manage student accounts, registration requests, roles, and access control
            </p>
          </div>
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5 whitespace-nowrap">
                      <div className="flex items-center gap-3">
                        ...
                        >
                          <FontAwesomeIcon
                            icon={u.role === 'admin' ? faUserTie : faUserGraduate}
                          />
                        </div>
                        <div>
                          <p className="font-bold text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-300 transition-colors">
                            {u.name}
                          </p>
                    ...
                    <td className="px-5 py-3.5 whitespace-nowrap">
                      <span
                        className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded text-xs font-semibold uppercase tracking-wider ${
                          u.role === 'admin'
                    ...
                    <td className="px-5 py-3.5 text-right whitespace-nowrap">
                      <div className="flex items-center justify-end gap-1.5">
                        ...
                        <button
                          onClick={() =>
                            onUpdateRole(u, u.role === 'admin' ? 'user' : 'admin')
                          }
                          title={
                            u.role === 'admin'
                              ? 'Demote to Student/User'
                              : 'Promote to Administrator'
                          }
                          className="flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 hover:bg-purple-100 dark:hover:bg-purple-500/20 hover:text-purple-600 dark:hover:text-purple-400 transition-colors"
                        >
